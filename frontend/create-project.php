...
// Temporary user session for testing
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if (empty($data['name']) || empty($data['description']) || empty($data['category']) || 
            ...
            throw new Exception('All fields are required and funding goal must be greater than 0.');
        }
...
<head>
    ...
    <!-- Stylesheets -->
    <link href="css/bostarter-master.css" rel="stylesheet">
...
<body>
                    ...
                    <form method="POST" enctype="multipart/form-data" class="project-form-card">
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="5" 
                                          placeholder="Describe your project, what makes it special, and why people should support it" required><?php echo isset($_POST['description']) ? htmlspecialchars($_POST['description']) : ''; ?></textarea>
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text">Upload a compelling image that represents your project (JPG, PNG, GIF, WebP - Max 5MB).</div>
    ...
    <!-- Scripts -->
    <script src="js/bostarter-master.js"></script>
