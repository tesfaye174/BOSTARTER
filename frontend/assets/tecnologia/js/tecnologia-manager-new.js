...
class TechnologyPageManager extends BaseCategoryManager {
    ...
    async loadProjects() {
        ...
        try {
            ...
            // Silent error handling for project loading
        }
    }
    ...
    async loadTechnologies() {
        try {
            ...
            // Silent error handling for technologies loading
        }
...
if ('serviceWorker' in navigator) {
    navigator.serviceWorker.register('/frontend/sw.js')
        .then(registration => {
            // SW registered successfully - silent handling
        })
        .catch(error => {
            // SW registration failed - silent handling  
        });
}
